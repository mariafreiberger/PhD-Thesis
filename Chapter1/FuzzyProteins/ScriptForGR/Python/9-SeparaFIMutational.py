with open("/home/maria/Documentos/InterfaceRes/CDRList_F") as DIRE:
    with open("/home/maria/Documentos/InterfaceRes/NeuMut.txt", "w") as CNM:
        with open("/home/maria/Documentos/InterfaceRes/MinMut.txt", "w") as MinTM:
            with open("/home/maria/Documentos/InterfaceRes/MaxMut.txt", "w") as MaxTM:
                with open("/home/maria/Documentos/InterfaceRes/Mut.txt", "w") as totalM:
                    d = 0
                    c0 = 0
                    ...
                    for lista in DIRE:
                        lista = lista.strip()
                        sp = lista.split(" ")
                        DE = open(f"/home/maria/Documentos/InterfaceRes/VPs/{sp[0]}/{sp[0]}.DistEuM")
