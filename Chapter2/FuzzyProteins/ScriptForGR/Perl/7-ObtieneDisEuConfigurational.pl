...
while($lista=<lista>){
	...
	open(guarda,">/home/maria/Documentos/InterfaceRes/VPs/@spchain[0]/@spchain[0].DistEuC");
	open(CR,"/home/maria/Documentos/InterfaceRes/VPs/@spchain[0]/@spchain[0].ResF");
	while(my $lineaCR=<CR>){
		chomp $lineaCR;
		my @splitterCR= split " ", $lineaCR;
		open(coordVP,"/home/maria/Documentos/InterfaceRes/VPs/@spchain[0]/@spchain[0].vpC");
