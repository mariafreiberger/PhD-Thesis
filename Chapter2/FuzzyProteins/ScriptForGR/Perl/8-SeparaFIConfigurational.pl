...
open(CNM, ">/home/maria/Documentos/InterfaceRes/NeuConf.txt");
open(MinTM, ">/home/maria/Documentos/InterfaceRes/MinConf.txt");
open(MaxTM, ">/home/maria/Documentos/InterfaceRes/MaxConf.txt");
open(totalM, ">/home/maria/Documentos/InterfaceRes/Conf.txt");
...
while(my $lista=<DIRE>){
	chomp $lista;
	my @sp=split " ",$lista;
	open(DE,"/home/maria/Documentos/InterfaceRes/VPs/@sp[0]/@sp[0].DistEuC");
	my $cont=0;
	while(my $DE=<DE>){
		chomp $DE;
		$cont++;
