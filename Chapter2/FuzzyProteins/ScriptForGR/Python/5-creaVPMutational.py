with open("/home/maria/Documentos/InterfaceRes/ListaRedundant_Unique") as DIRE:
    ...
    while lista:
        ...
        sp = lista.split(" ")
        spb = sp[0].split("_")
        guarda = open(f"/home/maria/Documentos/InterfaceRes/VPs/{sp[0]}/{sp[0]}.vpM", "w")
        frst = open(f"/home/maria/Documentos/InterfaceRes/{sp[0]}.pdb.done/FrustrationData/{sp[0]}.pdb_mutational")
