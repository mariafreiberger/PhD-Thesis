...
with open("/home/maria/Documentos/InterfaceRes/Fuzzy_NR") as lista:
    ...
    while line:
        ...
        guarda = open(f"/home/maria/Documentos/InterfaceRes/VPs/{spchain[0]}/{spchain[0]}.DistEuC", "w")
        CR = open(f"/home/maria/Documentos/InterfaceRes/VPs/{spchain[0]}/{spchain[0]}.ResF")

        for lineaCR in CR:
            lineaCR = lineaCR.strip()
            splitterCR = lineaCR.split(" ")
            coordVP = open(f"/home/maria/Documentos/InterfaceRes/VPs/{spchain[0]}/{spchain[0]}.vpC")
